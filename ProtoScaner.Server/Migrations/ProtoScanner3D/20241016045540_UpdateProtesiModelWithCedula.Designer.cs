...
namespace ProtoScaner.Server.Migrations.ProtoScanner3D
{
    ...
    [Migration("20241016045540_UpdateProtesiModelWithCedula")]
    partial class UpdateProtesiModelWithCedula
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Protesi", b =>
                {
                    b.HasOne("ProtoScaner.Server.Models.Paciente", "Paciente")
                        .WithMany("Protesis")
                        .HasForeignKey("Cedula")
                        .HasPrincipalKey("Cedula")
                        .IsRequired()
            ...
            modelBuilder.Entity("ProtoScaner.Server.Models.Entrega", b =>
                {
                    ...
                    b.HasOne("Protesi", "IdProtesisNavigation")
                        .WithMany("Entregas")
