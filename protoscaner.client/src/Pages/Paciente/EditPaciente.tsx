...
interface FormData {
    ...
    insidencia: boolean;
    comentario?: string;
    fotoPaciente?: string | null; // Base64 string sin prefijo o con prefijo seg�n necesidad
}
...
const EditPaciente: React.FC = () => {
    ...
    // Estados para la verificaci�n de la c�dula
    const [cedulaValid, setCedulaValid] = useState<boolean | null>(null); // null: no verificado, true: v�lido, false: inv�lido
        ...
        const fetchPaciente = async () => {
            if (id) {
                try {
                    ...
                    // Si no hay historial, `historial` permanece con valores vac�os
                } catch (error) {
    ...
    const handleChange = (
        ...
        // Si el campo que cambia es la c�dula, resetear la validaci�n
        if (name === 'cedula') {
            setCedulaValid(null);
        }
    ...
    // Funci�n para verificar la c�dula
    const verifyCedula = async () => {
        const cedula = formData.cedula.trim();
        if (cedula.length === 0) {
            toast.error('Por favor, ingresa una c�dula para verificar.');
            return;
        }
        ...
        try {
            ...
            if (data.valid) {
                setCedulaValid(true);
                toast.success('La cedula es v�lida.');
            } else {
                setCedulaValid(false);
                toast.error('La cedula es inv�lida.');
            }
        } catch (error) {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        console.log("Foto a enviar (base64):", fotoBase64); // Log para verificar la foto que se enviar�
        ...
        try {
            await updatePaciente(paciente.idPaciente, updatedPaciente, {
                ...historial,
                idHistorial: historial.idHistorial === 0 ? undefined : historial.idHistorial, // Si es 0, se crear� un nuevo historial
            });
            toast.success('Paciente actualizado con exito.');
            setSuccessDialogVisible(true); // Abrir el modal de �xito
    ...
    const handleDiscard = () => {
        if (id) {
            ...
            navigate('/'); // Ruta por defecto en caso de que id no est� disponible
        }
    };
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <Dropdown
                                ...
                                placeholder="Seleccione Tipo de Amputaci�n"
                        ...
                        <div>
                            ...
                            <Dropdown
                                ...
                                placeholder="Seleccione Lado de Amputaci�n"
                        ...
                        <div>
                            ...
                            <Dropdown
                                ...
                                placeholder="Seleccione Causa de Amputaci�n"
